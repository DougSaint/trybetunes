      ...
      <>
        ...
        <div className="flex justify-center items-center flex-col">
          <div className="forms w-[80vw] lg:w-[60vw] ">
            <label className="relative block rounded-xl w-full mx-auto">
              ...
              <input
                ...
                onKeyUp={(e) =>
                  e.key === "Enter" && searchMusic && this.searchAlbum()
                }
              />
          ...
          {searchComplete && search.length > 1 && (
            <h3 className="text-slate-50 my-2 ">
              Resultado de {lastSearch}
            </h3>
          )}
          {searchComplete && search.length < 1 && (
            <h3 className="text-slate-50 my-2 ">Nenhum álbum foi encontrado</h3>
          )}
